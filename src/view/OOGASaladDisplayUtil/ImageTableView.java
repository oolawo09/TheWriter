...
/**
 * JTable with images in the first column, and numbers in the second column
 * support multiple selections, toggling and adding button at the right upper corner (optional)
 * @author Xin
 *
 */
...
public class ImageTableView extends TableView {
	...
	public ImageTableView(String _label, EmptyBorder border, Dimension dim, boolean isMultiSelection, boolean isToggle, boolean hasButton, String buttonName) {
		super(_label, border, dim, isMultiSelection, isToggle, hasButton, buttonName);
