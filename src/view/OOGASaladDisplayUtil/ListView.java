 ...
 * support multiple selections and toggling
 * @author Xin
 *
 */
...
public class ListView extends Panel {
	...
	protected List<Object> selected = null;
	protected List<MouseAdapter> mouseActions = null;
	
	protected Boolean isToggle = false;
	protected Boolean isMultiSelection = false;
	
	public ListView(String _label, EmptyBorder border, Dimension dim, ViewController controller, boolean enableMultiSelection, boolean enableToggle) {
		...
		selected = new CopyOnWriteArrayList<Object>();
