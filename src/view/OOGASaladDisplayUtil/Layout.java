...
/**
 * A class to add new JComponent into a JPanel in a vertical way
 * <p>{@code hasLabel} support adding a label at the top of the panel
 * <p>{@code hasTag} show/hide tags
 * <p>{@code hasButton} show/hide button at the right upper corner
 * @author Xin
 *
 */
...
public class Layout extends Panel {
	 ...
	 * @param tag The name of this new panel
...
//		Assert.assertEquals(paths.length, names.length);
	...
	/**
	 * add {@code label} into a JPanel, normally used to display a list of images in horizontal way
	 * @param label
	 * @param path
	 */
