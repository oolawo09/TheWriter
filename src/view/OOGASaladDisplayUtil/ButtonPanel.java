...
public class ButtonPanel extends Panel {
	...
	/**
	 * enable/disable certain button with {@code name}
	 * @param name The name of the button
	 * @param b true if make button enabled, otherwise false
	 */
...
//		Assert.assertTrue(buttonMap.containsKey(name));
	...
	/**
	 * replace the {@code oldName} of some button with {@code newName} and new {@code action} for it
	 * @param oldName
	 * @param newName
	 * @param action
	 */
